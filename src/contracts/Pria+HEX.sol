...
*/
        ...
        returns (uint256[13] memory)
    {
        ...
        (_claimedBtcAddrCount, _claimedSatoshisTotal, _unclaimedSatoshisTotal) = (0,0,0);
        ...
        view
    {
        ...
        (g._claimedBtcAddrCount, g._claimedSatoshisTotal, g._unclaimedSatoshisTotal) = (0,0,0);
