...
contract TokenFarm {
    ...
    address[] public stakers;
       ...
       struct stakedInfoStruct{
        uint256 amount;
        uint256 timeStamp;
    }
    mapping(address => uint256) public stakingBalance;
    mapping(address => stakedInfoStruct) public stakedInfo;
    ...
    function StakeHistory(address _addr, uint256 _index) public returns (mapping(address => uint256)) 
    {
        if (stakingBalance[msg.sender] > 0 && hasStaked[msg.sender] == true)
        {
            return stakedInfo[msg.sender];
        }
        else 
        {
            return 0;
...
function stakeTokens(uint256 _amount) public {
        ...
        //log staked as Struct mapping
        stakedInfo[msg.sender].amount = stakingBalance[msg.sender].add(amount);
        stakedInfo[msg.sender].timeStamp = block.timestamp;
    }
